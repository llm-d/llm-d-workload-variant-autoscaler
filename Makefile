...
# E2E tests on Kind cluster for emulated autoscaling
...
test-e2e: manifests generate fmt vet ## Run the e2e tests. Expected an isolated environment using Kind.
	...
	export COLLECTOR_V2=1 KUBECONFIG=$(KUBECONFIG) K8S_EXPECTED_VERSION=$(K8S_VERSION) && go test ./test/e2e-emulated/... -timeout 30m -v -ginkgo.v $(FOCUS_ARGS) $(SKIP_ARGS)
